...
**Goal**: Get a first usable DM session in under 3 minutes with zero YAML editing. Defaults are safe (mock or read-only), secrets stay local, and users see clear next steps.
